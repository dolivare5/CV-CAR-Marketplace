 ...
 */
const getCategoriesHasSubCategoriesAssociated = async (_req, res) => {
    try {
        /* A database query that returns the Subcategory associated with each category and vice versa */
        /* Una consulta a la base de datos que devuelve la categoría asociada a cada subcategoría y viceversa. */
        const subcategoriesHasCategories = await db.query(`
 ...
 */
const getCategoriesAssociatedWithSubcategory = async (req, res) => {
    try {
 ...
 */
const getSubCategoriesAssociatedWithCategory = async (req, res) => {
    try {
...
const postCategoriesHasSubCategoriesAssociated = async (req, res) => {
    try {
        ...
        const validationsResults = await validateCategoriesAndSubcategories(req, res);
        ...
        /* A database query that returns the categories associated with a subcategory. */
        /* Una consulta a la base de datos que devuelve las categorías asociadas a una subcategoría. */
        const existCategories_has_subcategories = await db.query(`
        ...
        const newCategories_has_subcategories = new Categories_has_SubCategories(req.body);
 ...
 */
const validateCategoriesAndSubcategories = async (req, _res) => {
...
//# sourceMappingURL=categories_has_SubcategoriesController.js.map