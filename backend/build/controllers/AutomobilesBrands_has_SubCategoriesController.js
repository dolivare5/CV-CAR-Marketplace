 ...
 */
const getSubCategoriesHasBrandsAssociated = async (_req, res) => {
    try {
        /* A database query that returns the Subcategory associated with each category and vice versa */
        /* Una consulta a la base de datos que devuelve la subcategoría asociada a cada marca y viceversa. */
        const subcategoriesHasBrands = await db.query(`
 ...
 */
const getBrandsAssociatedWithSubcategory = async (req, res) => {
    try {
        ...
        const brandsAssociatedWithSubcategory = await db.query(`
 ...
 */
const getSubCategoriesHasAssociatedWithBrand = async (req, res) => {
    try {
        ...
        const subcategoriesAssociatedWithBrand = await db.query(`
 ...
 */
const postSubCategoriesHasBrands = async (req, res) => {
    try {
        ...
        const validationsResults = await validateSubcategoriesAndBrands(req, res);
        ...
        const subcategory = await Subcategories.findByPk(SubCategorySubCatId);
        /* Finding a brand by its brand id. */
        /* Encontrar una marca por su ID de marca. */
        const brand = await AutomobilesBrands.findByPk(BrandAutBraId);
        ...
        const existSubcategoryHasBrand = await AutomobilesBrands_has_SubCategories.findOne({
            where: {
                SubCategorySubCatId,
                BrandAutBraId
            }
        ...
        const newSubcategoryHasBrand = await AutomobilesBrands_has_SubCategories.create({
            SubCategorySubCatId,
            BrandAutBraId
        });
 ...
 */
const validateSubcategoriesAndBrands = async (req, _res) => {
...
//# sourceMappingURL=AutomobilesBrands_has_SubCategoriesController.js.map