...
/* A model is then created to associate the subcategories with the categories. It is important to note that this is an
...
(Marketplace). */
/* A continuación se crea un modelo para asociar las subcategorías con las las categorías. Es importante tener en cuenta
...
class Categories_has_SubCategories extends Model {
}
// @ts-ignore
Categories_has_SubCategories.init({
    ...
    timestamps: false,
    sequelize: db,
    modelName: 'Categories_has_SubCategories'
});
...
export default Categories_has_SubCategories;
//# sourceMappingURL=Categories_has_SubCategories.js.map