...
import {
    getCategoriesAndTypeVehiclesAssociated,
    getCategoriesAssociatedWithTypeVehicle,
    getVehiclesTypesAssociatedWithCategory, postCategoriesAndTypeVehiclesAssociated
} from "../controllers/categoriesTypeOfVehicleController";
