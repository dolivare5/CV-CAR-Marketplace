 ...
 */
const getCategoriesAndTypeVehiclesAssociated = async (_req: Request, res: Response) => {
    try{
        ...
        /* Una consulta a la base de datos que devuelve el tipo de vehículo asociado a cada categoría y viceversa.
        Una consulta a la base de datos que devuelve el tipo de vehículo asociado a cada categoría y viceversa */
        const categoriesAsTypeVehicles : Object[] = await db.query(`
 ...
 */
const getVehiclesTypesAssociatedWithCategory = async (req: Request, res: Response) => {
    try{
        ...
        const typeOfVehicles:Object[] = await db.query(`
 ...
 */
const getCategoriesAssociatedWithTypeVehicle = async (req: Request, res: Response) => {
    try{
...
const postCategoriesAndTypeVehiclesAssociated = async (req: Request, res: Response) => {
    try{
        ...
        const typeOfVehicle:TypeOfVehicles|null = await TypeOfVehicles.findByPk(TypeOfVehicleTypVehId);
        ...
        const existCategoryAndTypeVehiclesAssociated:Object[] = await db.query(`
        ...
        const categoryAndTypeVehiclesAssociated:Categories_TypeOfVehicle = new Categories_TypeOfVehicle(req.body);
