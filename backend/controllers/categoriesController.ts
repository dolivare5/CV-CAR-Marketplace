...
const getCategories = async (_req: Request, res: Response) => {
    ...
    try{
        ...
        const categories:Categories[] = await Categories.findAll({
...
const getCategory = async (req: Request, res: Response) => {
    ...
    try{
        ...
        const category:Categories|null = await Categories.findByPk(Cat_Id);
...
const postCategory = async (req: Request, res: Response) => {
    ...
    try {
        ...
        const resultsValidations : Object[] = await validateFieldsCategory(req, res);
        ...
        const existCategory:Categories|null = await Categories.findOne({
            where: {
        ...
        // @ts-ignore
        const category:Categories = new Categories(body);
...
const putCategory = async (req: Request, res: Response) => {
    try {
        ...
        */
        const existCategoryRepeated : Object[]  = await db.query(
            `SELECT * FROM "Categories" c WHERE "Cat_Id" != ${Cat_Id} AND "Cat_Name" = '${Cat_Name}'`,
