...
class Server {
    /*
        Spanish: atributo privado que corresponde a una aplicación de Express.
        
        English: private attribute corresponding to an Express application.
     */
    private app : Application;
    
    /*
        Spanish: atributo privado que almacena el puerto de conexión al servidor de Express.
        
        English: private attribute that stores the connection port to the Express server.
     */
